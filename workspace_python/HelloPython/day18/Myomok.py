...
form_class = uic.loadUiType("myqt20.ui")[0] #ui 경로 불러오기
class Myqt01(QMainWindow, form_class):
    def __init__(self):
        ...
        for i in range(20): 
            ...
            for j in range(20):
                ...
                pb.setGeometry(QtCore.QRect(40*j, 40*i, 40, 40))   #x y w h
                pb.clicked.connect(self.myclick) #클릭이벤트를 걸어줌
    ...
    def myclick(self):
        ...
        com_i = self.arr_ij[self.seq_i][0]
        com_j = self.arr_ij[self.seq_i][1]
        self.seq_i +=1
